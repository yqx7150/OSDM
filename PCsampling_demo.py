...
##################################################################
import sampling1e4
from sampling1e4 import ReverseDiffusionPredictor,LangevinCorrector,AnnealedLangevinDynamics ,EulerMaruyamaPredictor,AncestralSamplingPredictor
import C_aapm_sin_ncsnpp_gb as configs  # 修改config
##################################################################
...
#checkpoint_num = os.listdir("./exp/checkpoints")
#checkpoint_num = os.listdir("./exp_no_gyh/checkpoints")
checkpoint_num = os.listdir("./expnew")#少样本
  ...
  for correct in corrects:
    for check_num in checkpoint_num:
      ...
      if sde.lower() == 'vesde':
        ...
        #ckpt_filename = './exp_img/checkpoints/checkpoint_{}.pth'.format(check_num)

        ckpt_filename = './expnew/checkpoint_{}.pth'.format(check_num)
      ...
      snr = 0.0025#0.16 #@param {"type": "number"}#0.0025
      n_steps =  1#@param {"type": "integer"}
      probability_flow = False #@param {"type": "boolean"}
      sampling_fn = sampling1e4.get_pc_sampler(sde, predictor, corrector,
